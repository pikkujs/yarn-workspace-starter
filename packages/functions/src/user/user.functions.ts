...
export const loginUser: APIFunctionSessionless<JustUserName, UserSession> = async (services, { name }) => {
...
export const updateUser: APIFunctionSessionless<UpdateUser, void> = async (services, { userId, ...data }) => {
